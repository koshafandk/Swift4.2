...
/*:
 ...
 [SE-0197](https://github.com/apple/swift-evolution/blob/master/proposals/0197-remove-where.md "Introduce a new removeAll(where:) method that performs a high-performance, in-place filter for collections") introduces a new removeAll(where:) method that performs a high-performance, in-place filter for collections. You give it a closure condition to run, and it will strip out all objects that match the condition.
 */
var names = ["John", "Alice", "Bob"]
names.removeAll { $0.hasPrefix("Alice") }
names
/*:
 [Table of contents](Table%20of%20contents) • [Previous page](@previous) • [Next page](@next)
 */
